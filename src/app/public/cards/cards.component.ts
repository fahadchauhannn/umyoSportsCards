...
export class CardsComponent implements AfterViewInit{
  ...
  qrCode.addData('https://umyomilitary.site/cards/share-card/' + id);
  qrCode.make();
            ...
            .subscribe(
              ...
              (error) => {
                ...
                // this.showLoadingModal=false
                  ...
                  localStorage.removeItem("updatePaypalId");
                  localStorage.removeItem("updatedToken");
                  window.location.href='https://umyomilitary.site/'
              }
            );
          }
...
this.paymentForm = this.fb.group({
  ...
  openShareDialog() {
    const shareUrl = `https://umyomilitary.site/cards/share-card/${this.shareCardId}`;
