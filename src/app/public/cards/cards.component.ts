...
export class CardsComponent implements AfterViewInit{
  ...
  qrCode.addData('https://umyostylist.com/cards/share-card/' + id);
  qrCode.make();
            ...
            .subscribe(
              ...
              (error) => {
                ...
                // this.showLoadingModal=false
                  ...
                  localStorage.removeItem("updatePaypalId");
                  localStorage.removeItem("updatedToken");
                  window.location.href='https://umyostylist.com/'
              }
            );
          }
...
this.paymentForm = this.fb.group({
  ...
  openShareDialog() {
    const shareUrl = `https://umyostylist.com/cards/share-card/${this.shareCardId}`;
